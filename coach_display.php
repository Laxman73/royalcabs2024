...
if (empty($id)) {
	header('location:' . $URL_COACHLISTING);
	exit;
}
...
<head>
	...
	<title> <?php echo ($vehData->vName); ?> Bus/Coaches Rentals Goa | Royal Holidays</title>
	<meta name="description" content="Royal Holidays is a leading bus/coach rental service that offers <?php echo ($vehData->vName); ?>  bus for rent in Goa. Enjoy hassle-free travel in Goa." />
	...
	<meta property="og:title" content="<?php echo ($vehData->vName); ?> Bus/Coaches Rentals | Royal Holidays" />
	<meta property="og:description" content="Royal Holidays is a leading bus/coach rental service that offers <?php echo ($vehData->vName); ?> bus for rent in Goa. Enjoy hassle-free travel in Goa." />
	...
	<meta name="twitter:title" content="<?php echo ($vehData->vName); ?> Bus/Coaches Rentals | Royal Holidays" />
	<meta name="twitter:description" content="Royal Holidays is a leading bus/coach rental service that offers <?php echo ($vehData->vName); ?> bus for rent in Goa. Enjoy hassle-free travel in Goa." />
	<meta name="twitter:image" content="https://royalcabsgoa.com/images/Royal-holidays-og-image.png" />
	<link rel="canonical" href="https://royalcabsgoa.com/coach_display.php" />
		...
		<div class="container">
					...
					<div class="col-md-12">
						...
						<div class="w-100 mb-2 listing-card">
							...
							<div class="w-100 p-4  ">
								...
								<br><br>
								<?php if (false) { ?><s class="strike-text1">Rs.&nbsp;<?php echo $TARIFF_ARR[0]->fBaseFare; ?></s> <?php } ?>
								<br>
			...
			<optgroup class="arrival" label="Arrival Point">
				...
				?>
								...
								<div class="d-flex gap-10">
									...
									<div class="w-40">
										...
										<div class="inputWithIcon">
											<input type="text" value="<?php echo $PASS_ARR_COACH[$cmbpasses]; ?>" readonly>
				...
				<div class="col-md-8">
					...
					<img src="images/dis-car-5.png" class="responsive mt-10 mb-4">
					...
					<hr>
					<!-- <span class="card-head">Coach Desription</span> 
			...
			<div class="text-center mt-4 mb-2">
				<span class="card-head-b">Similar Coaches</span>
			</div>
					...
					<div class="column1">
						<div class="card">
							...
							<div class="container">
								...
								<br>
								<span class="card-head">Rs.&nbsp;<?php echo $price; ?></span> <?php if (false) { ?><s class="strike-text">RS.&nbsp;6000</s><?php } ?>
								<a href="<?php echo $URL_COACHLISTING . $params; ?>"><button type="button" class="search-btn wpx-165 mt-2">view details</button></a>
							</div>
						</div>
					</div>
				<?php
