...
<body>
			...
			<div class="row  no-gutters slider-text justify-content-start align-items-center justify-content-center">
				...
				<div class="column mt-50">
					<div class="text w-100 mb-md-5 pb-md-5">
						...
						<h1 class="mb-4">Travel in Style <br>in Goa</h1>
						<h3 class="text-white">Airport Transfers, Sightseeing, Travel at Ease. Hire our Taxi Cars or Coaches in Goa.</h3>
		...
		<div class="container">
			<div class="row justify-content-center mb-5">
				<div class="col-md-10 text-center heading-section">
					...
					<p class="text-white">Let the sun-kissed beaches of Goa welcome you with open arms and the gentle hum of the waves whisper your worries away. Experience an extraordinary vacation in this vibrant coastal paradise with Royal Holidays, your gateway to seamless Taxi Airport Transfers in Goa and beyond.
					</p>
					<p class="text-white">As the premier vehicle rental company in Goa, we're more than just wheels – we're your trusted travel partner. Explore hidden coves, bustling markets, and ancient temples nestled amidst swaying palm trees. Dive into the vibrant nightlife, savor delectable seafood, and lose yourself in the laid-back Goan charm.
					</p>
					<p class="text-white">Our impeccably maintained fleet – from luxury sedans to spacious SUVs – caters to every traveler's style and budget. Relax and enjoy the picturesque scenery through tinted windows, knowing our professional drivers navigate the winding roads with expertise. Forget the hassle of public transport and book your Taxi Airport Transfer in Goa with us for a smooth and stress-free arrival.
					</p>
					<p class="text-white">So, let Royal Holidays be your chariot to an unforgettable Goan adventure. We'll take care of the transportation, while you paint your own memories against the backdrop of this magical state. Contact us today and let your Goan getaway begin!
					</p>
					<br>
					<a href="https://royalcabsgoa.com/about_us.php"><button class="trans-btn">read more</button></a>
				</div>
			</div>
		</div>
	</section>
								...
								<div class="card">
									...
									<div class="container">
										...
										<div class="mob-div">
											...
											<div class="flx4"><span class="card-head">RS.<?php echo $row->fBaseFare; ?></span> <s class="strike-text">RS.6000</s></div>
											<div class="flx5"><button type="button" onclick="scrollToTopAndHighlight()" class="search-btn wpx-165 mt-2">Book Now</button></div>
										</div>
			...
			<div class="row no-gutters">
				...
				<div class="col-md-6 wrap-about ftco-animate">
					<div class="heading-section heading-section-white pl-md-5">
						...
						<br><br>
						<h2 class="mb-3 text-white">Explore the rest of India with Us</h2>
						<p class="text-white">Craving a break from Goa's sun-kissed shores? Buckle up for an adventure! Step beyond the beach bubble and explore India's hidden gems with Goan cabs. Outstation escapes await, whether it's scaling the misty hills of Kerala, marveling at ancient temples in Hampi, or feeling the pulse of Mumbai's bustling streets. No need to navigate unfamiliar roads, simply choose your destination, hop in a comfy cab, and let the journey weave its magic. From historic forts to serene waterfalls, discover a kaleidoscope of landscapes and cultures, all accessible through your Goa cab window. So, pack your thirst for discovery, ditch the train stress, and let your outstation cab be your chariot to unforgettable memories beyond Goa's golden sands.</p>
			...
			<div class="row d-flex  contact-info">
				<div class="col-md-6">
					...
					<div class="heading-section ftco-animate text-white">
						<h2 class="text-white">Let's Plan your Goa Travels!</h2>
						<p class="text-white">Goa's beauty beckons, Ditch the stress of navigation and let local experts handle your wheels. From airport pickups to beachside bliss, their comfy fleet caters to every whim. Need adventure? Outstation trips unlock India's treasures. Safety, comfort, and reliability are their promise, so talk to us at Royal Cabs Goa and let your Goan holiday unfold, worry-free.</p>
					</div>
					...
					<div class="row mb-5 mt-40">
						<div class="col-md-12 mb-3">
							<div class=" w-100 rounded mb-2 d-flex1">
								...
								<p class="footer-p">Royal Holidays India,<br>Below Club National,<br>Waglo Building, MG Road,<br> Panjim Goa - 403001</p>
							</div>
						</div>
						<div class="col-md-12">
							<div class="w-100  rounded mb-2 d-flex1">
						...
						<div class="col-md-12">
							<div class="w-100 rounded mb-2 d-flex1">
								...
								<p class="footer-p"><a href="mailto:info@royalcabsgoa.com" class="text-white">info@royalcabsgoa.com</a></p>
							</div>
						</div>
					</div>
				...
				<div class="col-md-6 block-9">
					<div class="content content-test-1">
						<form action="contact_mail.php" method="post" id="enqform2" name="enqform2">
							<input type="hidden" name="srch_mode" id="srch_mode" value="QUERY" />
							<div class="d-flex gap-10">
								<div class="w-50">
							...
							<div class="d-flex gap-10">
								<div class="w-50">
									...
									<input type="text" onkeypress="return numbersonly(event);" maxlength="10" name="mobile" id="mobile">
								</div>
							...
							<div class="d-flex gap-10">
								<div class="w-50">
									<label class="form-label">From</label>
									<div class="inputWithIcon">
										<select id="cmbfrom2" name="cmbfrom" class="from-control selectTime" onchange="getTOlocation();" required>
											<option value="">Select</option>
											<optgroup class="arrival" label="Arrival Point">
												<?php
												foreach ($HOTSPOT_ARR as $key => $value) {
								...
								<div class="w-50">
									<label class="form-label">To</label>
									<div class="inputWithIcon">
										<?php echo FillCombo($cmbto, 'cmbto2', 'COMBO', '', $LOC_ARR, 'required', ' selectTime'); ?>
									</div>
								</div>
							...
							<div class="d-flex gap-10">
								...
								<div class="w-50">
									<label class="form-label">Date</label>
									<div class="inputWithIcon">
										<input type="date" name="txtdate" onchange="GetTimeDropdown();" min="<?php echo TODAY; ?>" value="<?php echo $txtdate; ?>" id="txtdate2" placeholder="DD/MM/YYYY" required>
										<!--<i class="date"></i>-->
									</div>
								</div>
								...
								<div class="w-50">
									<label class="form-label">Pax</label>
									<div class="inputWithIcon">
										<?php echo FillCombo($cmbpasses, 'cmbpasses2', 'COMBO', '', $PASS_ARR, 'required', 'from-control selectTime'); ?>
									</div>
								</div>
							...
							<!--		<br>-->
									<!--<button type="submit" class="search-btn">SUBMIT </button>-->
							<!--		<button class="g-recaptcha search-btn wpx-165 mt-2" data-sitekey="6LfUmlQpAAAAABdkarT4wS3wvMFNsYIh-SbrHoNA" data-callback='onSubmit' data-action='submit'>submit</button>-->
							<!--	</div>-->
							<!--</div>-->
	...
	<script>
		...
		function onSubmit(token) {
			...
			var mobile = $('#mobile');
			var vtype = $('#vtype');
			var cmbfrom = $('#cmbfrom2');
			var cmbto = $('#cmbto2');
			var cmbpasses=$('#cmbpasses2');
			var txtdate=$('#txtdate2');
			var msg=$('#msg');

			if ($.trim(name.val()) == '') {
				ShowError(name, "please enter the name ");
				err++; //return false;
			} else {
				HideError(name);
			}
		...
		if (!validateEmail($.trim(email.val()))) {
			...
			if ($.trim(vtype.val()) == '') {
				ShowError(vtype, "please select type of vehicle  ");
				err++; //return false;
			} else {
				HideError(vtype);
			}
			...
			if ($.trim(cmbfrom.val()) == '') {
				ShowError(cmbfrom, "please select the arrival location   ");
				err++; //return false;
			} else {
				HideError(cmbfrom);
			}
			...
			if ($.trim(cmbto.val()) == '') {
				ShowError(cmbto, "please select the location departure location");
				err++; //return false;
			} else {
				HideError(cmbto);
			}
			...
			if(!(txtdate.val()))
			{
				ShowError(txtdate, "please pick a date ");
				err++; //return false;
			...
			if (return_val) {
				document.getElementById("enqform2").submit();
	...
	<script>
		function scrollToTopAndHighlight() {
			...
			// Highlight the top div
			var topDiv = document.getElementById('content-test-1');
			topDiv.style.backgroundColor = 'white';
			topDiv.style.border = '1px solid red';

			// Reset the highlight after 3 seconds (adjust as needed)
			setTimeout(function() {
